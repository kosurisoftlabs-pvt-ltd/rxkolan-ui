...
import { useSearchSalesMutation } from '../../../services/apis/SaleService';


const SalesReport = () => {

    let  { salesList } = useSelector((state) => state.sales);
    ...
    const handleSearchSales = async()=>{
        try {
            ...
            await searchSales(payload).unwrap()
        ...
        <div className='ambulance-container'>
            ...
            <form action="">
                <div className="filter_items_box">
                    ...
                    <div className="filter_item">
                        <input type="button" className="form-control search-control bg_self btn-success" style={{marginTop:'34px'}} value={'Search'} onClick={handleSearchSales}/>
                    </div>
                </div>
            </form>
        </div>
